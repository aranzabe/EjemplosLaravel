...
Route::get('rutaLibre', [App\Http\Controllers\miControlador::class, 'unaRuta']);
Route::get('rutaProtegida', [App\Http\Controllers\miControlador::class, 'otraRuta'])->middleware('auth');
 ...
 */
Route::get('autBasica ',[App\Http\Controllers\miControlador::class, 'unaRuta'])->middleware('auth.basic');
